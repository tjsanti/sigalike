...
from sigalike import __version__
...
project = "sigalike"
copyright = f"{date.today().year}, Trevor Santiago"
...
# LinkCode
code_url = f"https://github.com/tjsanti/sigalike/blob/{git_commit}"
